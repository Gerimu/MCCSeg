...
class SwinTransformerSys(nn.Module):
    ...
    def forward_features(self, x, x2, x3, x4):
        add2 = x2
        add3 = x3
        add4 = x4
    ...
    #
    #     # DeepSupervision
    #     out4, out3, out2, out1 = self.guidance(x_deeploss, edge_guidance)  # DS
    #     # out4, out3, out2, out1 = self.guidance(x_deeploss)
    #     # DeepSupervision
    #
    #     x = self.up_x4(x)
    #
